...
define('components/datasettable',['exports', '../components/projectapi'], function (exports, _projectapi) {
  'use strict';
...
define('components/projecttable',["exports", "../components/messages", "./projectapi"], function (exports, _messages, _projectapi) {
  "use strict";
  ...
  var Projecttable = exports.Projecttable = (_temp = _class = function () {
    ...
    Projecttable.prototype.activate = function activate(params, routeConfig, navigationInstruction) {
    ...
    Projecttable.prototype.filterProject = function filterProject() {
      var _this2 = this;
      ...
      if (this.projects.length > 0) {
        this.selectedProject = this.projects.filter(function (i) {
          return i.id == _this2.selectedProjectId;
        })[0];
    ...
    Projecttable.prototype.filterDataset = function filterDataset() {
      var _this3 = this;

      console.log("filterDataset()");
      console.log(this.alldatasets);
      this.datasets = this.alldatasets.filter(function (filtereditem) {
        return filtereditem.projectId == _this3.selectedProjectId;
      });
...
define('resources/index',['exports'], function (exports) {
  ...
  function configure(config) {
    config.globalResources(['./irep.html', './irepdemo.html', './iadmin.html', './istaff.html', './ifile.html', './ilink.html', './icopy', './ifolder.html', './idata.html', './iproject.html', './itable.html', './ispincog.html', './iupload']);
  }
});
  ...
  var Dashboarddetail = exports.Dashboarddetail = (_temp = _class = function () {
    ...
    Dashboarddetail.prototype.attached = function attached() {
      ...
      this.pa.getDatasets().then(function (data) {
        ...
        _this.emptyDatasets = _this.datasets.length == 0;
      });
    };

    Dashboarddetail.prototype.selectProposal = function selectProposal(id) {
      this.showProposals = false;
      this.showDatasets = true;
    ...
    Dashboarddetail.prototype.filterProject = function filterProject() {
      var _this3 = this;
    ...
    Dashboarddetail.prototype.filterDataset = function filterDataset() {
      var _this4 = this;
...
define('text!components/projecttable.html', ['module'], function(module) { module.exports = "<template>\n<table class=\"w3-table-all\">\n  <tr>\n    <th>id</th>\n    <th>name</th>\n    <th>summary</th>\n  </tr>\n  <tr show.bind=\"showProposals\" class=\"au-animate\" repeat.for=\"project of projects\">\n    <td>${project.id}</td>\n    <td><iproject></iproject><a class=\"w3-hover-green\" route-href=\"route: projectdetail; params.bind: {projectid:project.id}\">${project.projectName}</a>\n    </td>\n    <td><a class=\"w3-hover-green\" route-href=\"route: projectdetail; params.bind: {projectid:project.id}\">${project.summary} (${project.datasets})</a></td>\n  </tr>\n  <tr show.bind=\"! showProposals\" title=\"click to show all projects\" class=\"w3-hover-green\">\n    <td>${selectedProject.id}</td>\n    <td ><iproject></iproject><a class=\"w3-hover-green\" route-href=\"route: dashboard\">\n      ${selectedProject.projectName}\n    </a>\n    </td>\n    <td>${selectedProject.summary}</td>\n  </tr>\n</table>\n</template>\n"; });
