    ...
    Datasettable.prototype.filterProjectDatasets2 = function filterProjectDatasets2(id) {
      ...
      if (mydataset.length > 0) {
        ...
        this.datasets = this.alldatasets.filter(function (i) {
          return i.projectId == _this3.selectedProjectId;
        });
        console.log("datasets:");
        console.log(this.datasets);

        this.ea.publish(new _messages.Preselectedproject(this.selectedProjectId));
...
define('components/messages',["exports"], function (exports) {
  ...
  var Preselectedproject = exports.Preselectedproject = function Preselectedproject(projectid) {
    _classCallCheck(this, Preselectedproject);
...
define('components/projecttable',['exports', '../components/messages', './projectapi', 'aurelia-event-aggregator', './messages'], function (exports, _messages, _projectapi, _aureliaEventAggregator, _messages2) {
  'use strict';
  ...
  var Projecttable = exports.Projecttable = (_temp = _class = function () {
    function Projecttable(pa, ea) {
      ...
      this.ea.subscribe(_messages2.Preselectedproject, function (msg) {
        return _this.filterSelectedProposal(msg.projectid);
      });
    }
    ...
    Projecttable.prototype.selectProject = function selectProject(project) {
      ...
      this.ea.publish(new _messages2.Selectedproject(project));
      return true;
    };
    ...
    Projecttable.prototype.deselectProject = function deselectProject() {
      ...
      this.selectedProject = null;
      this.ea.publish(new _messages2.Selectedproject(null));
      return true;
    };
