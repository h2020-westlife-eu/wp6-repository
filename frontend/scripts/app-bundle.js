...
define('components/datasettable',['exports', '../components/projectapi', 'aurelia-event-aggregator', './messages'], function (exports, _projectapi, _aureliaEventAggregator, _messages) {
  'use strict';
  ...
  var Datasettable = exports.Datasettable = (_temp = _class = function () {
...
define('components/projectapi',["exports", "aurelia-fetch-client"], function (exports, _aureliaFetchClient) {
  ...
  var ProjectApi = exports.ProjectApi = (_temp = _class = function () {
    ...
    ProjectApi.prototype.getDatasets = function getDatasets() {
      ...
      });else return this.httpclient.fetch(this.dataurl).then(function (response) {
        return response.json();
      }).then(function (data) {
