...
define('repositoryapp',['exports'], function (exports) {
  ...
  var Repositoryapp = exports.Repositoryapp = function () {
    ...
    Repositoryapp.prototype.configureRouter = function configureRouter(config, router) {
      ...
      config.map([{ route: ['', 'dashboard'], name: 'dashboard', moduleId: 'scientist/dashboard', nav: true, title: 'Visitor Dashboard' }, { route: 'dashboard/project/:projectid/', name: 'projectdetail', moduleId: 'scientist/dashboarddetail' }, { route: 'dashboard/dataset/:datasetid/', name: 'datasetdetail', moduleId: 'scientist/dashboarddetail' }, { route: 'createdataset', name: 'createdataset', moduleId: 'scientist/createdataset', nav: true, title: 'Create Empty Dataset' }, { route: 'repositorytovf', name: 'repositorytovf', moduleId: 'scientist/repositorytovf', nav: true, title: 'Upload to Virtual Folder' }]);
      this.router = router;
    };
...
define('staffapp',['exports'], function (exports) {
  ...
  var Staffapp = exports.Staffapp = function () {
    ...
    Staffapp.prototype.configureRouter = function configureRouter(config, router) {
      config.title = 'West-Life Repository Router';
      config.map([{ route: ['', 'dashboard'], name: 'dashboard', moduleId: 'staff/dashboard', nav: true, title: 'Staff Dashboard' }, { route: 'upselectuser', name: 'upselectuser', moduleId: 'staff/upselectuser', nav: true, title: 'Upload - Select Visitor User' }, { route: 'upselectdataset', name: 'upselectdataset', moduleId: 'staff/upselectdataset', nav: true, title: 'Upload - Select/create target dataset' }, { route: 'upselectdata', name: 'upselectdata', moduleId: 'staff/upselectdata', nav: true, title: 'Upload - Select data' }, { route: 'upconfirm', name: 'upconfirm', moduleId: 'staff/upconfirm', nav: true, title: 'Upload - Confirmation' }]);
      this.router = router;
    };
...
define('components/ariaapi',['exports', 'aurelia-fetch-client'], function (exports, _aureliaFetchClient) {
  'use strict';
  ...
  var Ariaapi = exports.Ariaapi = (_temp = _class = function () {
    ...
    Ariaapi.prototype.getAriaLink = function getAriaLink() {
      return this.httpclient.fetch(this.accesstokenserviceurl).then(function (response) {
        return response.json();
      }).then(function (data) {
        return data;
      }).catch(function (error) {
...
define('components/ariaapixhr',["exports", "aurelia-http-client"], function (exports, _aureliaHttpClient) {
  ...
  var Ariaapi = exports.Ariaapi = (_temp = _class = function () {
    ...
    Ariaapi.prototype.getProposalList = function getProposalList() {
      ...
      if (this.accesstoken && this.accesstoken.access_token) {
        return this.httpclient.get(this.proposallisturl + "?access_token=" + this.accesstoken.access_token).then(function (data) {
          console.log("ariaapixhr.getProposalList()");
          console.log(data);
          _this3.proposallistwrapper = JSON.parse(data.response);
          return _this3.proposallistwrapper.proposals;
        }).catch(function (error) {
...
define('components/csrfheaderinterceptor',["exports", "aurelia-fetch-client"], function (exports, _aureliaFetchClient) {
  "use strict";

  Object.defineProperty(exports, "__esModule", {
    value: true
  });
  exports.Csrfheaderinterceptor = undefined;
  ...
  var Csrfheaderinterceptor = function () {
    function Csrfheaderinterceptor() {
      _classCallCheck(this, Csrfheaderinterceptor);

      this.TOKEN_HEADER = 'X-CSRF-TOKEN';
      this.latestCsrfToken;
    }

    Csrfheaderinterceptor.prototype.response = function response(_response) {
      console.log("csrfheaderinterceptor, headers:");
      console.log(_response.headers);
      if (_response.headers.has(this.TOKEN_HEADER)) {
        this.latestCsrfToken = _response.headers.get(this.TOKEN_HEADER);
      }
      return _response;
    };

    Csrfheaderinterceptor.prototype.request = function request(_request) {
      if (this.latestCsrfToken) {
        console.log(_request);
        console.log(this.latestCsrfToken);
        if (['POST', 'PUT', 'PATCH'].indexOf(_request.method) >= 0) {
          _request.headers.add(this.TOKEN_HEADER, this.latestCsrfToken);
        }
      }
      return _request;
    };

    return Csrfheaderinterceptor;
  }();

  exports.Csrfheaderinterceptor = Csrfheaderinterceptor;
});
define('components/datasettable',['exports', '../components/projectapi', 'aurelia-event-aggregator', './messages', 'aurelia-framework'], function (exports, _projectapi, _aureliaEventAggregator, _messages, _aureliaFramework) {
  'use strict';

  Object.defineProperty(exports, "__esModule", {
    value: true
  });
  exports.Datasettable = undefined;
  ...
  var Datasettable = exports.Datasettable = (_class = (_temp = _class2 = function () {
    function Datasettable(pa, ea) {
      var _this = this;

      _classCallCheck(this, Datasettable);

      _initDefineProp(this, 'userid', _descriptor, this);

      this.pa = pa;
      this.alldatasets = [];

      this.ea = ea;
      this.ea.subscribe(_messages.FilterDataset, function (msg) {
        return _this.filterSelectedDataset(msg.id);
      });
    ...
    Datasettable.prototype.attached = function attached() {
      console.log("datasettable attached()");
    };

    Datasettable.prototype.bind = function bind() {
      var _this2 = this;

      console.log("datasettable bind()", this.userid);
      this.pa.getDatasets(this.userid).then(function (data) {
        _this2.alldatasets = data;
        _this2.datasets = _this2.alldatasets;
        _this2.selectedDatasetId = _this2.pa.getSelectedDataset();
        if (_this2.selectedDatasetId > 0) _this2.filterSelectedDataset(_this2.selectedDatasetId);
        if (_this2.selectedProjectId > 0) _this2.filterProjectDatasets2(_this2.selectedProjectId);
      });
    };

    Datasettable.prototype.selectDataset = function selectDataset(dataset) {
      console.log("selectDataset() sending signal");
      console.log(dataset);
      this.selectedDataset = dataset;
      this.ea.publish(new _messages.Selecteddataset(dataset));

      return true;
    };

    Datasettable.prototype.deselectDataset = function deselectDataset() {

      console.log("deselectDataset()");
      this.filterProjectDatasets(this.selectedDataset.projectId);
      this.ea.publish(new _messages.Selecteddataset(null));
      return true;
    };
    ...
    Datasettable.prototype.filterProjectDatasets = function filterProjectDatasets(id) {
    ...
    Datasettable.prototype.filterSelectedDataset = function filterSelectedDataset(id) {
      ...
      if (this.datasets.length > 0) {
        ...
        this.ea.publish(new _messages.FilterProjectByDataset(this.datasets[0].projectId));
        this.pa.dataseturl = this.datasets[0].webdavurl;
        this.ea.publish(new _messages.Webdavresource(this.pa.dataseturl));
      }
    };

    Datasettable.prototype.deleteDataset = function deleteDataset() {
      var _this3 = this;

      this.pa.deleteDataset(this.selectedDatasetId).then(function (data) {
    ...
    return Datasettable;
  }(), _class2.inject = [_projectapi.ProjectApi, _aureliaEventAggregator.EventAggregator], _temp), (_descriptor = _applyDecoratedDescriptor(_class.prototype, 'userid', [_aureliaFramework.bindable], {
    enumerable: true,
    initializer: null
  })), _class);
});
define('components/fileeditor',["exports", "codemirror", "aurelia-event-aggregator", "aurelia-fetch-client", "./messages", "./nmrapi", "aurelia-framework", "codemirror/mode/clike/clike", "codemirror/mode/htmlmixed/htmlmixed", "codemirror/mode/javascript/javascript"], function (exports, _codemirror, _aureliaEventAggregator, _aureliaFetchClient, _messages, _nmrapi, _aureliaFramework) {
  "use strict";
  ...
  var Fileeditor = exports.Fileeditor = (_class = (_temp = _class2 = function () {
    function Fileeditor(ea, httpclient, nmrapi) {
      var _this = this;
    ...
    Fileeditor.prototype.selectFile = function selectFile(file) {
      ...
      if (!this.isimage) this.client.fetch(file.webdavurl, { credentials: 'same-origin', headers: { 'Range': 'bytes=0-4095' } }).then(function (response) {
        var response2 = response.clone();
        response.blob().then(function (data2) {
          that.data = {};
          var bindata = that.nmrapi.convert(data2, that.data, that.ht2);
        });
    ...
    return Fileeditor;
  }(), _class2.inject = [_aureliaEventAggregator.EventAggregator, _aureliaFetchClient.HttpClient, _nmrapi.Nmrapi], _temp), (_descriptor = _applyDecoratedDescriptor(_class.prototype, "pid", [_aureliaFramework.bindable], {
    enumerable: true,
    initializer: null
  })), _class);
});
define('components/htable',["exports", "handsontable"], function (exports, _handsontable) {
  "use strict";

  Object.defineProperty(exports, "__esModule", {
    value: true
  });
  exports.htable = undefined;
  ...
  var htable = exports.htable = function () {
    function htable() {
      _classCallCheck(this, htable);
    }

    htable.prototype.attached = function attached() {
      this.data = [[1, 2], [1, 3]];
      this.ht = new _handsontable.Handsontable(this.idtable, {
        data: this.data,
        rowHeaders: true,
        colHeaders: true
      });
...
define('components/importaria',['exports', '../components/ariaapi'], function (exports, _ariaapi) {
  'use strict';

  Object.defineProperty(exports, "__esModule", {
    value: true
  });
  exports.Importaria = undefined;
  ...
  var Importaria = exports.Importaria = (_temp = _class = function () {
    function Importaria(ariaapi) {
      _classCallCheck(this, Importaria);
    ...
    Importaria.prototype.attached = function attached() {
      var _this = this;

      this.ariaapi.getAriaLink().then(function (linkdata) {
        console.log('importaria.attached() recieved linkdata');
        console.log(linkdata);
        _this.ariaurl = linkdata.url;
...
define('components/messages',["exports"], function (exports) {
  ...
  var Selectedproject = exports.Selectedproject = function Selectedproject(project) {
    _classCallCheck(this, Selectedproject);

    this.project = project;
  };

  var FilterProject = exports.FilterProject = function FilterProject(id) {
    _classCallCheck(this, FilterProject);

    this.id = id;
  };

  var FilterDatasetByProject = exports.FilterDatasetByProject = function FilterDatasetByProject(id) {
    _classCallCheck(this, FilterDatasetByProject);

    this.id = id;
  };

  var FilterDataset = exports.FilterDataset = function FilterDataset(id) {
    _classCallCheck(this, FilterDataset);

    this.id = id;
  };

  var FilterProjectByDataset = exports.FilterProjectByDataset = function FilterProjectByDataset(id) {
    _classCallCheck(this, FilterProjectByDataset);

    this.id = id;
  };

  var Selecteddataset = exports.Selecteddataset = function Selecteddataset(dataset) {
    _classCallCheck(this, Selecteddataset);

    this.dataset = dataset;
  };

  var Preselecteddataset = exports.Preselecteddataset = function Preselecteddataset(datasetid) {
    _classCallCheck(this, Preselecteddataset);
...
define('components/nmrapi',["exports"], function (exports) {
  ...
  var Nmrapi = exports.Nmrapi = function () {
    function Nmrapi() {
      _classCallCheck(this, Nmrapi);
    }

    Nmrapi.prototype.convert = function convert(blob, data, handsontable) {
      ...
      fileReader.addEventListener("loadend", function () {
        ...
        if (uint8Array[0] === 35) {
          ...
          var indexbindata = uint8Array.indexOf(26);
          var uint82 = new Uint8Array(uint8Array, indexbindata + 1);
        ...
        data.ri = [];
        for (var i = 0; i + 1 < data.raw.length; i += 2) {
...
define('components/projectapi',["exports", "aurelia-fetch-client"], function (exports, _aureliaFetchClient) {
  ...
  var ProjectApi = exports.ProjectApi = (_temp = _class = function () {
    function ProjectApi(httpclient, ea) {
      ...
      if (this.apiavailable) this.httpclient.fetch(this.authurl, { method: "POST" }).catch(function (error) {
        return alert("Backend service not running: " + error.statusText);
      });
    ...
    ProjectApi.prototype.getUserProjects = function getUserProjects() {
      return getProjects(this.selectedUser.Id);
    };

    ProjectApi.prototype.getProjects = function getProjects(userid) {
      var _this = this;

      console.log("projectapi,getProjects()", userid);
      var userprojecturl = userid ? this.userinfourl + "/" + userid + "/project" : this.projecturl;

      if (this.projects.length > 0) return new Promise(function (resolve) {
        return resolve(_this.projects);
      });else return this.httpclient.fetch(userprojecturl).then(function (response) {
        return response.json();
      }).then(function (data) {
        _this.projects = data;
        return data;
    ...
    ProjectApi.prototype.setSelectedProject = function setSelectedProject(id) {
      this.selectedProjectId = id;
    };

    ProjectApi.prototype.getSelectedProject = function getSelectedProject() {
      return this.selectedProjectId;
    };

    ProjectApi.prototype.getUserDatasets = function getUserDatasets() {
      return getDatasets(this.selectedUser.Id);
    };

    ProjectApi.prototype.getDatasets = function getDatasets(userid) {
      var _this2 = this;

      console.log("projectapi,getDatasets()", userid);
      var userdataurl = userid ? this.userinfourl + "/" + userid + "/dataset" : this.dataurl;

      if (this.datasets.length > 0) return new Promise(function (resolve) {
        return resolve(_this2.datasets);
      });else return this.httpclient.fetch(userdataurl).then(function (response) {
        return response.json();
      }).then(function (data) {
    ...
    ProjectApi.prototype.setSelectedDataset = function setSelectedDataset(id) {
      this.selectedDatasetId = id;
    };

    ProjectApi.prototype.getSelectedDataset = function getSelectedDataset() {
      return this.selectedDatasetId;
    };

    ProjectApi.prototype.submitDataset = function submitDataset(dataset) {
      var _this3 = this;

      return this.httpclient.fetch(this.dataurl, { method: 'post', body: (0, _aureliaFetchClient.json)(dataset) }).then(function (response) {
        return response.json();
      }).then(function (data) {
    ...
    ProjectApi.prototype.getStaffUserInfo = function getStaffUserInfo() {
      return this.httpclient.fetch(this.staffuserinfourl).then(function (response) {
        return response.json();
      }).then(function (data) {
        return data;
      }).catch(function (error) {
    ...
    ProjectApi.prototype.deleteDataset = function deleteDataset(id) {
      return this.httpclient.fetch(this.dataurl + "/" + id, { method: "delete" }).then(function (response) {
        return response.json();
      }).then(function (data) {
        return data;
      });
    ...
    ProjectApi.prototype.copytask = function copytask(src, dest) {
      return this.httpclient.fetch(this.copytaskurl, { method: "post", body: (0, _aureliaFetchClient.json)({ sourceurl: src, webdavurl: dest }) }).then(function (response) {
        return response.json();
      }).then(function (data) {
        return data;
      });
...
define('components/projecttable',['exports', './projectapi', 'aurelia-event-aggregator', './messages', 'aurelia-framework'], function (exports, _projectapi, _aureliaEventAggregator, _messages, _aureliaFramework) {
  'use strict';

  Object.defineProperty(exports, "__esModule", {
    value: true
  });
  exports.Projecttable = undefined;
  ...
  var Projecttable = exports.Projecttable = (_class = (_temp = _class2 = function () {
    function Projecttable(pa, ea) {
      var _this = this;
      ...
      this.ea.subscribe(_messages.FilterProject, function (msg) {
        return _this.filterSelectedProposal(msg.id);
      });
      this.ea.subscribe(_messages.Addproject, function (msg) {
        return _this.addProposal(msg.project);
      });
      this.ea.subscribe(_messages.FilterProjectByDataset, function (msg) {
        return _this.filterSelectedProposal(msg.id);
      });
      console.log("Projecttable() subscribe 2");
    }

    Projecttable.prototype.bind = function bind() {
      var _this2 = this;

      console.log("projecttable bind()", this.userid);
      this.pa.getProjects(this.userid).then(function (data) {
        _this2.projects = data;

        _this2.selectedProjectId = _this2.pa.getSelectedProject();
        console.log(_this2.selectedProjectId);
        if (_this2.selectedProjectId > 0) _this2.filterSelectedProposal(_this2.selectedProjectId);
      });
    };

    Projecttable.prototype.filterSelectedProposal = function filterSelectedProposal(id) {
      this.selectedProjectId = id;
    ...
    Projecttable.prototype.selectProject = function selectProject(project) {
      console.log("selectProject()");
      this.selectedProject = project;
      this.ea.publish(new _messages.Selectedproject(project));
      return true;
    };

    Projecttable.prototype.deselectProject = function deselectProject() {
      console.log("deselectProject()");
      this.selectedProject = null;
      this.ea.publish(new _messages.Selectedproject(null));
      return true;
    };

    Projecttable.prototype.addProposal = function addProposal(pr) {
...
define('components/searchbydate',["exports"], function (exports) {
  "use strict";
  ...
  var Searchbydate = exports.Searchbydate = function Searchbydate() {
    _classCallCheck(this, Searchbydate);
  };
});
define('components/staffuserinfo',["exports", "./projectapi"], function (exports, _projectapi) {
  "use strict";

  Object.defineProperty(exports, "__esModule", {
    value: true
  });
  exports.Staffuserinfo = undefined;
  ...
  var Staffuserinfo = exports.Staffuserinfo = (_temp = _class = function () {
    function Staffuserinfo(projectapi) {
      _classCallCheck(this, Staffuserinfo);

      this.pa = projectapi;
      this.showuserinfo = false;
    }

    Staffuserinfo.prototype.attached = function attached() {
      var _this = this;

      this.pa.getStaffUserInfo().then(function (data) {
        console.log(data);
        _this.userinfo = data;
...
define('components/webdavfilepanel',['exports', 'aurelia-fetch-client', 'aurelia-event-aggregator', './messages'], function (exports, _aureliaFetchClient, _aureliaEventAggregator, _messages) {
  ...
  var Webdavfilepanel = exports.Webdavfilepanel = (_temp = _class = function () {
    ...
    Webdavfilepanel.prototype.atached = function atached() {
      ...
      this.httpclient.fetch(this.webdavpath, {
        ...
        for (var _iterator = filesDOM, _isArray = Array.isArray(_iterator), _i = 0, _iterator = _isArray ? _iterator : _iterator[Symbol.iterator]();;) {
          ...
          if (filename != _this2.webdavpath) {
              ...
              item.date = filedate;
              item.nicedate = _this2.formatdate(new Date(filedate));
    ...
    Webdavfilepanel.prototype.formatdate = function formatdate(date) {
...
define('resources/index',['exports'], function (exports) {
  ...
  function configure(config) {
    config.globalResources(['./irep.html', './irepdemo.html', './iadmin.html', './istaff.html', './ifile.html', './ilink.html', './icopy', './ifolder.html', './idata.html', './iproject.html', './itable.html', './ispincog.html', './iupload', './idelete.html', './inext.html', './icopyicon.html']);
  }
});
define('resources/iupload',["exports", "aurelia-framework", "../components/projectapi"], function (exports, _aureliaFramework, _projectapi) {
  "use strict";

  Object.defineProperty(exports, "__esModule", {
    value: true
  });
  exports.Iupload = undefined;
  ...
  var Iupload = exports.Iupload = (_class = (_temp = _class2 = function () {
    function Iupload(pa) {
      var _this = this;

      _classCallCheck(this, Iupload);
      ...
      this.receiveMessage = function (event) {
        _this.uploadhref = event.data;
        if (_this.uploadhref && _this.uploadhref.length > 0) {
          console.log("Iupload.receiveMessage()");
          console.log("will upload from:" + _this.hreffull);
          console.log("              to:" + _this.uploadhref);
          _this.pa.copytask(_this.href, _this.uploadhref);
        }
      };
    }

    Iupload.prototype.attached = function attached() {
      var port = window.location.port == "" || window.location.port == "80" || window.location.port == "443" ? "" : ":" + window.location.port;
    ...
    Iupload.prototype.dettached = function dettached() {
      window.removeEventListener("message", this.receiveMessage);
    };

    Iupload.prototype.openwindow = function openwindow(href) {
      this.popup = window.open(href, 'newwindow', 'width=640, height=480');
    };

    Iupload.prototype.uploadtovf = function uploadtovf() {
      this.openwindow('https://portal.west-life.eu/virtualfolder/uploaddirpickercomponent.html');
    };

    return Iupload;
  }(), _class2.inject = [_projectapi.ProjectApi], _temp), (_descriptor = _applyDecoratedDescriptor(_class.prototype, "href", [_aureliaFramework.bindable], {
    enumerable: true,
    initializer: null
  })), _class);
});
define('scientist/createdataset',['exports', '../components/messages', 'aurelia-event-aggregator', '../components/projectapi', 'aurelia-framework'], function (exports, _messages, _aureliaEventAggregator, _projectapi, _aureliaFramework) {
  'use strict';
  ...
  var Createdataset = exports.Createdataset = (_class = (_temp = _class2 = function () {
  ...
  }(), _class2.inject = [_aureliaEventAggregator.EventAggregator, _projectapi.ProjectApi], _temp), (_descriptor = _applyDecoratedDescriptor(_class.prototype, 'userid', [_aureliaFramework.bindable], {
    enumerable: true,
    initializer: null
  })), _class);
});
define('scientist/dashboard',["exports", "../components/ariaapixhr", "../components/projectapi", "../components/messages", "aurelia-event-aggregator"], function (exports, _ariaapixhr, _projectapi, _messages, _aureliaEventAggregator) {
  "use strict";
  ...
  var Dashboard = exports.Dashboard = (_temp = _class = function () {
    function Dashboard(ariaapi, pa, ea) {
    ...
    Dashboard.prototype.attached = function attached() {
      ...
      if (this.code && this.state) {
        ...
        this.ariaapi.getAccessToken(this.code, this.state).then(function (accessToken) {
          console.log("Dashboard.attached() accestoken:");
          console.log(accessToken);
          _this.importingaria = false;
          if (accessToken.error_description) {
            ...
            _this.ariaapi.getProposalList().then(function (list) {
              ...
              console.log(list);
              _this.proposals = list;
            }).catch(function (error) {
              _this.importariastatus = error.statusText;
              _this.importariaerror = true;
            });
          }
        });
    ...
    Dashboard.prototype.importProposal = function importProposal(p) {
      ...
      this.importingaria = true;
      this.pa.submitProject(pr).then(function (data) {
        _this3.importingaria = false;
        _this3.ea.publish(new _messages.Addproject(data));
      }).catch(function (error) {
        _this3.importingaria = false;
    ...
    return Dashboard;
  }(), _class.inject = [_ariaapixhr.Ariaapi, _projectapi.ProjectApi, _aureliaEventAggregator.EventAggregator], _temp);
});
...
define('staff/dashboard',["exports"], function (exports) {
  "use strict";
...
define('staff/upconfirm',['exports', '../components/projectapi', 'aurelia-fetch-client'], function (exports, _projectapi, _aureliaFetchClient) {
  'use strict';

  Object.defineProperty(exports, "__esModule", {
    value: true
  });
  exports.Upconfirm = undefined;
  ...
  var Upconfirm = exports.Upconfirm = (_temp = _class = function () {
    function Upconfirm(pa, client) {
      _classCallCheck(this, Upconfirm);
    ...
    return Upconfirm;
  }(), _class.inject = [_projectapi.ProjectApi, _aureliaFetchClient.HttpClient], _temp);
});
define('staff/upselectdata',["exports", "../components/projectapi"], function (exports, _projectapi) {
  "use strict";

  Object.defineProperty(exports, "__esModule", {
    value: true
  });
  exports.Upselectdata = undefined;
  ...
  var Upselectdata = exports.Upselectdata = (_temp = _class = function () {
    function Upselectdata(pa) {
      _classCallCheck(this, Upselectdata);
    ...
    Upselectdata.prototype.attached = function attached() {
    ...
    Upselectdata.prototype.dropped = function dropped(event) {
      var _filestoupload;
    ...
    Upselectdata.prototype.dragged = function dragged(event) {
      return true;
    };

    Upselectdata.prototype.appendFiles = function appendFiles(event) {
      var _filestoupload2;
    ...
    Upselectdata.prototype.appendDir = function appendDir(event) {
      var _filestoupload3;
    ...
    Upselectdata.prototype.submitUpload = function submitUpload() {
      var _filesuploaded;

      console.log("submitUpload()");
      (_filesuploaded = this.filesuploaded).unshift.apply(_filesuploaded, this.filestoupload);
      this.filestoupload = [];
    };

    Upselectdata.prototype.selectitem = function selectitem(item) {
      console.log("Selected", item);
    };

    Upselectdata.prototype.deleteitem = function deleteitem(item) {
      var indexremoved = this.filesuploaded.indexOf(item);
...
define('staff/upselectdataset',['exports', '../components/messages', 'aurelia-event-aggregator', 'aurelia-router', '../components/projectapi'], function (exports, _messages, _aureliaEventAggregator, _aureliaRouter, _projectapi) {
  'use strict';

  Object.defineProperty(exports, "__esModule", {
    value: true
  });
  exports.Upselectdataset = undefined;
  ...
  var Upselectdataset = exports.Upselectdataset = (_temp = _class = function () {
    function Upselectdataset(ea, ro, pa) {
      var _this = this;

      _classCallCheck(this, Upselectdataset);

      this.ea = ea;
      this.router = ro;
      this.pa = pa;
      this.ea.subscribe(_messages.Selecteddataset, function (msg) {
        return _this.selectedDataset(msg.dataset);
      });
    }

    Upselectdataset.prototype.selectedDataset = function selectedDataset(dataset) {
      console.log('Upselectdataset.selectedDataset()');
      this.pa.selectedDataset = dataset;
      this.router.navigate("upselectdata");
    };

    return Upselectdataset;
  }(), _class.inject = [_aureliaEventAggregator.EventAggregator, _aureliaRouter.Router, _projectapi.ProjectApi], _temp);
});
define('staff/upselectuser',['exports', '../components/projectapi'], function (exports, _projectapi) {
  'use strict';

  Object.defineProperty(exports, "__esModule", {
    value: true
  });
  exports.Upselectuser = undefined;
  ...
  var Upselectuser = exports.Upselectuser = (_temp = _class = function () {
    function Upselectuser(pa) {
      _classCallCheck(this, Upselectuser);

      this.visitors = [];
      this.pa = pa;
    }

    Upselectuser.prototype.attached = function attached() {
      var _this = this;
    ...
    Upselectuser.prototype.selectUser = function selectUser(user) {
...
define('text!staff/upselectdataset.html', ['module'], function(module) { module.exports = "<template>\n  <require from=\"../components/datasettable\"></require>\n  <require from=\"../scientist/createdataset\"></require>\n  <h3>Upload</h3>\n\n  <h4>Select Dataset</h4>\n  <p>Select dataset for user:<a route-href=\"route:selectuser\" title=\"ammend selection of user\">(${pa.selectedUser.Id}) ${selectedUser.FirstName} ${selectedUser.LastName}</a></p>\n\n  <datasettable userid.bind=\"pa.selectedUser.Id\"></datasettable>\n  <h4>Or Create New Dataset</h4>\n  <createdataset userid.bind=\"pa.selectedUser.Id\"></createdataset>\n\n\n</template>\n"; });
