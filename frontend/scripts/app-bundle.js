...
define('staffapp',['exports'], function (exports) {
  ...
  var Staffapp = exports.Staffapp = function () {
    ...
    Staffapp.prototype.configureRouter = function configureRouter(config, router) {
      config.title = 'West-Life Repository Router';
      config.map([{ route: ['', 'dashboard'], name: 'dashboard', moduleId: 'staff/repositorystaff', nav: true, title: 'Visitor Experiment Dashboard' }, { route: 'dataupload', name: 'dataupload', moduleId: 'staff/dataupload', nav: true, title: 'Visitor Dataset Upload' }]);
      this.router = router;
    };
...
define('components/datasettable',['exports', '../components/projectapi', 'aurelia-event-aggregator', './messages'], function (exports, _projectapi, _aureliaEventAggregator, _messages) {
  ...
  var Datasettable = exports.Datasettable = (_temp = _class = function () {
    ...
    Datasettable.prototype.deselectProject = function deselectProject() {
...
define('resources/index',['exports'], function (exports) {
  ...
  function configure(config) {
    config.globalResources(['./irep.html', './irepdemo.html', './iadmin.html', './istaff.html', './ifile.html', './ilink.html', './icopy', './ifolder.html', './idata.html', './iproject.html', './itable.html', './ispincog.html', './iupload', './idelete.html']);
  }
});
