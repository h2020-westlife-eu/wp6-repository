define('app',['exports'], function (exports) {
  ...
  var App = exports.App = function () {
    ...
    App.prototype.configureRouter = function configureRouter(config, router) {
      ...
      config.map([{ route: ['', 'home'], name: 'home', moduleId: 'visitingscientist/visitingscientist', nav: true, title: 'Dataset Dashboard' }, { route: 'repositorystaff', name: 'repositorystaff', moduleId: 'repositorystaff/repositorystaff', nav: true, title: 'File Upload Tool' }, { route: 'repositorytovf', name: 'repositorytovf', moduleId: 'repositorytovf/repositorytovf', nav: true, title: 'Upload to Virtual Folder' }]);
      this.router = router;
    };
...
define('repositorytovf/repositorytovf',["exports", "aurelia-http-client"], function (exports, _aureliaHttpClient) {
  "use strict";
