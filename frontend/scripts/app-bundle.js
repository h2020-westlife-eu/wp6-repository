...
define('components/projecttableselect',['exports', 'aurelia-event-aggregator', './projectapi', '../components/messages'], function (exports, _aureliaEventAggregator, _projectapi, _messages) {
  'use strict';

  Object.defineProperty(exports, "__esModule", {
    value: true
  });
  exports.Projecttableselect = undefined;
  ...
  var Projecttableselect = exports.Projecttableselect = (_temp = _class = function () {
    function Projecttableselect(pa, ea) {
      _classCallCheck(this, Projecttableselect);
    ...
    Projecttableselect.prototype.attached = function attached() {
      var _this = this;
    ...
    Projecttableselect.prototype.selectProject = function selectProject(project) {
      this.selectedProject = project;
      this.ea.publish(new _messages.Selectedproject(project));
    };

    Projecttableselect.prototype.deselectProject = function deselectProject() {
      this.selectedProject = null;
      this.ea.publish(new _messages.Selectedproject(null));
    };

    return Projecttableselect;
  }(), _class.inject = [_projectapi.ProjectApi, _aureliaEventAggregator.EventAggregator], _temp);
});
...
define('text!components/projecttableselect.html', ['module'], function(module) { module.exports = "<template>\n  <table class=\"w3-table-all\">\n    <tr>\n      <th>id</th>\n      <th>name</th>\n      <th>summary</th>\n    </tr>\n    <tr show.bind=\"!selectedProject\" class=\"w3-hover-green\" repeat.for=\"project of projects\" click.delegate=\"selectProject(project)\">\n      <td>${project.id}</td>\n      <td><iproject></iproject>${project.projectName}</td>\n      <td>${project.summary} (${project.datasets})</td>\n    </tr>\n    <tr show.bind=\"selectedProject\" title=\"click to show all projects\" class=\"w3-hover-green\" click.delegate=\"deselectProject()\">\n      <td>${selectedProject.id}</td>\n      <td ><iproject></iproject>${selectedProject.projectName}</td>\n      <td>${selectedProject.summary}</td>\n    </tr>\n  </table>\n</template>\n"; });
