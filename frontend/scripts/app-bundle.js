...
define('components/fileeditor',["exports", "codemirror", "aurelia-event-aggregator", "aurelia-fetch-client", "./messages", "aurelia-framework", "codemirror/mode/clike/clike", "codemirror/mode/htmlmixed/htmlmixed", "codemirror/mode/javascript/javascript"], function (exports, _codemirror, _aureliaEventAggregator, _aureliaFetchClient, _messages, _aureliaFramework) {
  ...
  var Fileeditor = exports.Fileeditor = (_class = (_temp = _class2 = function () {
    ...
    Fileeditor.prototype.selectFile = function selectFile(file) {
      ...
      if (!this.isimage) this.client.fetch(file.webdavurl, { credentials: 'same-origin' }).then(function (response) {
...
define('components/userinfo',['exports', 'aurelia-fetch-client'], function (exports, _aureliaFetchClient) {
  'use strict';
  ...
  var Userinfo = exports.Userinfo = (_temp = _class = function () {
    ...
    Userinfo.prototype.attached = function attached() {
      ...
      this.httpclient.fetch("/restcon/user").then(function (response) {
...
define('components/webdavfilepanel',['exports', 'aurelia-fetch-client', 'aurelia-event-aggregator', './messages'], function (exports, _aureliaFetchClient, _aureliaEventAggregator, _messages) {
  ...
  var Webdavfilepanel = exports.Webdavfilepanel = (_temp = _class = function () {
    ...
    Webdavfilepanel.prototype.selectFile = function selectFile(file) {
      ...
      this.ea.publish(new _messages.Editfile(file));
    };
...
define('repository/app',['exports'], function (exports) {
  ...
  var App = exports.App = function () {
    ...
    App.prototype.configureRouter = function configureRouter(config, router) {
      config.title = 'West-Life Repository Router';
      config.map([{ route: ['', 'home'], name: 'home', moduleId: 'scientist/visitingscientist', nav: true, title: 'Dataset Dashboard' }, { route: 'repositorytovf', name: 'repositorytovf', moduleId: 'scientist/repositorytovf', nav: true, title: 'Upload to Virtual Folder' }]);
      this.router = router;
    };
...
define('scientist/repositorytovf',['exports', 'aurelia-event-aggregator', '../components/messages'], function (exports, _aureliaEventAggregator, _messages) {
  ...
  var Repositorytovf = exports.Repositorytovf = (_temp = _class = function () {
    function Repositorytovf(ea) {
      ...
      this.items = [{ name: "sucrose.t1", size: 133511, date: "18/06/2001" }, { name: "hetcor.2d", size: 525832, date: "18/06/2001" }, { name: "menth.c13", size: 132108, date: "18/06/2001" }, { name: "noesy.fid", size: 1640436, date: "18/06/2001" }, { name: "hsqc.fid", size: 2098448, date: "18/06/2001" }, { name: "hmbc.fid", size: 2098448, date: "18/06/2001" }];
      this.filestoupload = [];
      this.uploadfiles = [];
      this.uploaddir = "";
...
define('scientist/visitingscientist',['exports', 'aurelia-fetch-client', '../components/messages', 'aurelia-event-aggregator'], function (exports, _aureliaFetchClient, _messages, _aureliaEventAggregator) {
  'use strict';
  ...
  var Visitingscientist = exports.Visitingscientist = (_temp = _class = function () {
    function Visitingscientist(ea, httpclient) {
      ...
      this.itemsall = [{ projectId: "1", date: "06/09/2017", summary: "spectrum of strychnine process with v_noesy_pro.mac (NUTS-Pro) or v_noesy.mac (NUTS-2D)", info: "1.6 Mb", webdavurl: "/files/XufWqKa1/" }, { projectId: "1", date: "07/09/2017", summary: " spectrum of sucrose (1.3 Mbytes); process with v_ghsqc_pro.mac (NUTS-Pro) or v_ghsqc.mac (NUTS-2D)", info: "1.3 Mb", webdavurl: "/files/XufWqKa2/" }, { projectId: "2", date: "08/09/2017", summary: "spectrum of strychnine (2.1 Mbytes); process with v_hsqc_pro.mac (NUTS-Pro) or v_hsqc.mac (NUTS-2D).", info: "2.1 Mb", webdavurl: "/files/XufWqKa3/" }];
      this.files = [{ name: "sucrose.t1", size: 133511, date: "18/06/2001" }, { name: "hetcor.2d", size: 525832, date: "18/06/2001" }, { name: "menth.c13", size: 132108, date: "18/06/2001" }, { name: "noesy.fid", size: 1640436, date: "18/06/2001" }, { name: "hsqc.fid", size: 2098448, date: "18/06/2001" }, { name: "hmbc.fid", size: 2098448, date: "18/06/2001" }];
    ...
    Visitingscientist.prototype.attached = function attached() {
      ...
      this.httpclient.fetch("/restcon/project").then(function (response) {
        return response.json();
      }).then(function (data) {
      ...
      this.httpclient.fetch("/restcon/data").then(function (response) {
        return response.json();
      }).then(function (data) {
        console.log(data);
        _this.itemsall = data;
    ...
    Visitingscientist.prototype.selectProposal = function selectProposal(item) {
      ...
      this.items = this.itemsall.filter(function (filtereditem) {
    ...
    Visitingscientist.prototype.selectDataset = function selectDataset(item) {
    ...
    Visitingscientist.prototype.deselectDataset = function deselectDataset() {
      this.showDatasets = true;
    };

    Visitingscientist.prototype.selectFile = function selectFile(file) {
...
define('staff/app',['exports'], function (exports) {
  'use strict';
...
define('staff/main',['exports', '../environment'], function (exports, _environment) {
  'use strict';
...
define('staff/repositorystaff',["exports", "aurelia-http-client"], function (exports, _aureliaHttpClient) {
  "use strict";
  ...
  var Repositorystaff = exports.Repositorystaff = (_temp = _class = function () {
    function Repositorystaff(httpclient) {
    ...
    Repositorystaff.prototype.attached = function attached() {
      ...
      this.client.get(this.serviceurl).then(function (data) {
        if (data.response) {
          _this.visitors = JSON.parse(data.response);
        }
      }).catch(function (error) {
        console.log(error);
      });
