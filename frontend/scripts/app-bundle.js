...
define('components/projectapi',["exports", "aurelia-fetch-client"], function (exports, _aureliaFetchClient) {
  ...
  var ProjectApi = exports.ProjectApi = (_temp = _class = function () {
    ...
    ProjectApi.prototype.getProjects = function getProjects() {
      ...
      });else return this.httpclient.fetch(this.projecturl).then(function (response) {
        return response.json();
      }).then(function (data) {
        _this.projects = data;
        return data;
...
define('components/projecttable',['exports', './projectapi', 'aurelia-event-aggregator', './messages'], function (exports, _projectapi, _aureliaEventAggregator, _messages) {
  'use strict';
  ...
  var Projecttable = exports.Projecttable = (_temp = _class = function () {
    ...
    Projecttable.prototype.attached = function attached() {
      var _this2 = this;
    ...
    return Projecttable;
  }(), _class.inject = [_projectapi.ProjectApi, _aureliaEventAggregator.EventAggregator], _temp);
});
