...
define('repository/app',['exports', 'aurelia-http-client'], function (exports, _aureliaHttpClient) {
  'use strict';
  ...
  var App = exports.App = (_temp = _class = function () {
    ...
    App.prototype.selectItem = function selectItem(item) {
...
define('repositorystaff/app',['exports', 'aurelia-http-client'], function (exports, _aureliaHttpClient) {
  'use strict';
  ...
  var App = exports.App = (_temp = _class = function () {
    function App(httpclient) {
      ...
      this.items = [{ date: "06/09/2017", name: "v_noesy.mac", info: "1.6 Mb" }, { date: "07/09/2017", name: "v_ghsqc_pro.mac", info: "1.3 Mb" }, { date: "08/09/2017", name: "sqcstrychnine.sqc", info: "2.1 Mb" }];
    ...
    App.prototype.selectItemToUpload = function selectItemToUpload(item) {
      console.log("selected item");
      console.log(item);
    };

    App.prototype.removeItemToUpload = function removeItemToUpload(item) {
      console.log("selected item");
      console.log(item);
    ...
    App.prototype.dropped = function dropped(event) {
      var _filestoupload;
    ...
    App.prototype.dragged = function dragged(event) {
      return true;
    };

    App.prototype.appendFiles = function appendFiles(event) {
      var _filestoupload2;
    ...
    App.prototype.appendDir = function appendDir(event) {
      var _filestoupload3;
    ...
    App.prototype.submitUpload = function submitUpload() {
      var _items;
...
define('repositorystaff/main',['exports', '../environment'], function (exports, _environment) {
  'use strict';
...
define('text!app.html', ['module'], function(module) { module.exports = "<template>\n    <require from=\"./w3.css\"></require>\n    <require from=\"./navitem\"></require>\n    <div class=\"w3-margin\">\n      <navitem href=\"index.html\">Rep Home</navitem>\n    </div>\n      <div class=\"w3-card-2 w3-white w3-margin w3-padding\">\n        <h3>Repository</h3>\n        <p>\n          You can access your data at the institutional repository.\n\n          <button class=\"w3-button\" click.delegate=\"login()\">Login</button>\n        </p>\n\n      </div>\n\n</template>\n"; });
