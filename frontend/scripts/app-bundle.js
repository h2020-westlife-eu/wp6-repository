  ...
  var Userinfo = exports.Userinfo = (_temp = _class = function () {
    function Userinfo(httpclient) {
      ...
      this.httpclient.configure(function (config) {
        config.rejectErrorResponses().withBaseUrl('/restcon/').withDefaults({
    ...
    Userinfo.prototype.attached = function attached() {
      ...
      this.httpclient.fetch("user").then(function (response) {
...
define('scientist/visitingscientist',['exports', 'aurelia-fetch-client'], function (exports, _aureliaFetchClient) {
  'use strict';
  ...
  var Visitingscientist = exports.Visitingscientist = (_temp = _class = function () {
    function Visitingscientist(httpclient) {
      ...
      this.itemsall = [{ projectId: "1", date: "06/09/2017", summary: "spectrum of strychnine process with v_noesy_pro.mac (NUTS-Pro) or v_noesy.mac (NUTS-2D)", info: "1.6 Mb" }, { projectId: "1", date: "07/09/2017", summary: " spectrum of sucrose (1.3 Mbytes); process with v_ghsqc_pro.mac (NUTS-Pro) or v_ghsqc.mac (NUTS-2D)", info: "1.3 Mb" }, { projectId: "2", date: "08/09/2017", summary: "spectrum of strychnine (2.1 Mbytes); process with v_hsqc_pro.mac (NUTS-Pro) or v_hsqc.mac (NUTS-2D).", info: "2.1 Mb" }];
    ...
    Visitingscientist.prototype.attached = function attached() {
      ...
      this.httpclient.fetch("project").then(function (response) {
        return response.json();
      }).then(function (data) {
      ...
      this.httpclient.fetch("data").then(function (response) {
        return response.json();
      }).then(function (data) {
        console.log(data);
        _this.itemsall = data;
    ...
    Visitingscientist.prototype.getFirstElementByTagName = function getFirstElementByTagName(fileitem, tag) {
...
define('components/webdavfilepanel',['exports', 'aurelia-fetch-client', 'aurelia-event-aggregator'], function (exports, _aureliaFetchClient, _aureliaEventAggregator) {
  'use strict';
  ...
  var Webdavfilepanel = exports.Webdavfilepanel = (_temp = _class = function () {
    function Webdavfilepanel(ea, httpclient) {
      ...
      this.ea.subscribe(Webdavresource, function (msg) {
        return _this.setwebdav();
      });
      this.webdavpath = '/files/XufWqKau/';
    }

    Webdavfilepanel.prototype.attached = function attached() {
      var _this2 = this;
