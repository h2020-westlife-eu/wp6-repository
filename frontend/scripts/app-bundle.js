...
define('repositoryapp',['exports'], function (exports) {
  ...
  var Repositoryapp = exports.Repositoryapp = function () {
    ...
    Repositoryapp.prototype.configureRouter = function configureRouter(config, router) {
      ...
      config.map([{ route: ['', 'dashboard'], name: 'dashboard', moduleId: 'scientist/dashboard', nav: true, title: 'Repository Dashboard' }, { route: 'dashboard/project/:projectid/', name: 'projectdetail', moduleId: 'scientist/dashboarddetail' }, { route: 'dashboard/dataset/:datasetid/', name: 'datasetdetail', moduleId: 'scientist/dashboarddetail' }, { route: 'repositorytovf', name: 'repositorytovf', moduleId: 'scientist/repositorytovf', nav: true, title: 'Upload to Virtual Folder' }]);
      this.router = router;
    };
