  ...
  var Ariaapi = exports.Ariaapi = (_temp = _class = function () {
    function Ariaapi(httpclient) {
      ...
      this.httpclient.configure(function (config) {
        config.rejectErrorResponses().withBaseUrl('https://www.structuralbiology.eu/').withDefaults({
...
define('components/importaria',["exports"], function (exports) {
  "use strict";
  ...
  var Importaria = exports.Importaria = function () {
    function Importaria() {
    ...
    Importaria.prototype.attached = function attached() {
      this.ariaurl = this.oaservice + "authorize?client_id=" + this.client_id + "&state=" + this.oastate;
    };
...
define('resources/index',['exports'], function (exports) {
  ...
  function configure(config) {
    config.globalResources(['./irep.html', './irepdemo.html', './iadmin.html', './istaff.html', './ifile.html', './ilink.html', './icopy', './ifolder.html', './idata.html', './iproject.html', './itable.html']);
  }
});
define('scientist/dashboard',["exports"], function (exports) {
  "use strict";
...
define('text!components/importaria.html', ['module'], function(module) { module.exports = "<template>\n  <a href.bind=\"ariaurl\" class=\"w3-button w3-small w3-round-small\">Import from ARIA service</a>\n</template>\n"; });
