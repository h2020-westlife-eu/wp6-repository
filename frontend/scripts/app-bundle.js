...
define('staff/repositorystaff',["exports", "aurelia-http-client"], function (exports, _aureliaHttpClient) {
  ...
  var Repositorystaff = exports.Repositorystaff = (_temp = _class = function () {
    ...
    Repositorystaff.prototype.attached = function attached() {
      ...
      this.httpclient.get(this.serviceurl).then(function (data) {
        if (data.response) {
