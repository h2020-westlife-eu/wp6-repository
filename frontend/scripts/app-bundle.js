    ...
    Dashboard.prototype.attached = function attached() {
      ...
      this.pa.getDatasets().then(function (data) {
        ...
        if (_this.selectedProjectId > 0) {
          ...
          _this.items = _this.itemsall.filter(function (filtereditem) {
