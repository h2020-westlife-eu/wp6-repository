...
define('repository/app',['exports'], function (exports) {
  ...
  var App = exports.App = function () {
    ...
    App.prototype.configureRouter = function configureRouter(config, router) {
      config.title = 'West-Life Repository Router';
      config.map([{ route: ['', 'dashboard'], name: 'dashboard', moduleId: 'scientist/dashboard', nav: true, title: 'Dataset Dashboard' }, { route: 'dashboard/project/:projectid/', name: 'projectdetail', moduleId: 'scientist/dashboard' }, { route: 'repositorytovf', name: 'repositorytovf', moduleId: 'scientist/repositorytovf', nav: true, title: 'Upload to Virtual Folder' }]);
      this.router = router;
    };

    App.prototype.login = function login() {};

    App.prototype.activate = function activate(params, routeConfig) {
...
define('scientist/dashboard',['exports', 'aurelia-fetch-client', '../components/messages', 'aurelia-event-aggregator'], function (exports, _aureliaFetchClient, _messages, _aureliaEventAggregator) {
  'use strict';
  ...
  var Dashboard = exports.Dashboard = (_temp = _class = function () {
    function Dashboard(ea, httpclient) {
