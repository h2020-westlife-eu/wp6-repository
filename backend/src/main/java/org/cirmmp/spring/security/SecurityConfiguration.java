...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers("/login","/static/**","/restcon/dataset","/restcon/dataset/**","/restcon/copytask","/restcon/project","/restcon/user","/restcon/authsso").permitAll() //was with /restcon/authsso
